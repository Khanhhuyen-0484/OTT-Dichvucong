...
/**
 * Upload file qua backend (server đẩy lên S3), tránh lỗi CORS khi PUT trực tiếp từ browser.
 */
export async function uploadToS3(file) {
  ...
  try {
    // Không set Content-Type thủ công để axios tự gắn boundary cho multipart.
