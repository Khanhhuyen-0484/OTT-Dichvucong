...
export async function getAllMyApplications() { return api.get("/services/my-applications?scope=all"); }
...
export async function generatePaymentQr(payload) { return api.post("/payments/bank-transfer/create", payload); }
export async function verifyPaymentStatus(applicationCode) { return api.get(`/payments/status/${applicationCode}`); }
export async function mockPaymentComplete(applicationCode) { return api.post("/payments/mock-complete", { dossierId: applicationCode }); }
...
export async function postGroupInviteResponse(roomId, action) { return api.post(`/chat/groups/${roomId}/invites/respond`, { action }); }
...
export async function getAdminDossier(id) { return api.get(`/admin/dossiers/${id}`); }
