...
export default function Home() {
  ...
  const services = useMemo(
    () => [
      { icon: FileText, title: "Hộ tịch", desc: "Khai sinh, kết hôn, trích lục bản sao theo quy trình điện tử.", id: "ho-tich-khai-sinh" },
      { icon: FolderKanban, title: "Đất đai", desc: "Đăng ký biến động đất đai, cấp đổi giấy chứng nhận quyền sử dụng.", id: "dat-dai-bien-dong" },
      { icon: Building2, title: "Xây dựng", desc: "Xin cấp phép xây dựng, điều chỉnh hồ sơ và theo dõi tiến độ.", id: "xay-dung-cap-phep" },
      { icon: Landmark, title: "Hộ chiếu", desc: "Nộp hồ sơ cấp/đổi hộ chiếu và nhận thông báo xử lý trực tuyến.", id: "ho-chieu-pho-thong" },
      { icon: CarFront, title: "Giao thông", desc: "Đổi giấy phép lái xe, đăng ký phương tiện và tra cứu vi phạm.", id: "gplx-doi" },
      { icon: ClipboardList, title: "Doanh nghiệp", desc: "Đăng ký kinh doanh, thay đổi thông tin và dịch vụ chuyên ngành.", id: "doanh-nghiep-thanh-lap" }
    ],
    []
  );
