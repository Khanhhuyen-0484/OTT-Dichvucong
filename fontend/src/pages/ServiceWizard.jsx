      ...
      <div style={styles.container}>
        ...
        <div style={styles.grid}>
          ...
          <div style={styles.sideCol}>
            {!user ? (
              <div style={styles.card}>
                <SectionTitle icon={LogIn} title="Đăng nhập để nộp hồ sơ" />
                <div style={styles.loginRequiredBox}>
                  <div style={styles.loginRequiredTitle}>Bạn đang xem thông tin dịch vụ</div>
                  <div style={styles.loginRequiredText}>
                    Người dùng chưa đăng nhập chỉ có thể xem thông tin, giấy tờ cần chuẩn bị, thời gian xử lý và câu hỏi thường gặp. Vui lòng đăng nhập để nộp hồ sơ trực tuyến, thanh toán lệ phí và theo dõi tiến độ.
                  </div>
                  <div style={styles.actions}>
                    <button type="button" style={styles.primaryBtn} onClick={() => navigate("/auth")}>
                      Đăng nhập / Đăng ký
                    </button>
                    <Link to="/services" style={styles.linkBtnSecondary}>Xem dịch vụ khác</Link>
                  </div>
                </div>
              </div>
            ) : step === 1 && (
...
const styles = {
  ...
  loginRequiredBox: { background: "#f8fafc", border: "1px solid #e2e8f0", borderRadius: 18, padding: 16 },
  loginRequiredTitle: { fontWeight: 900, color: "#0f172a", marginBottom: 8 },
  loginRequiredText: { color: "#475569", lineHeight: 1.7, fontSize: 14 },
