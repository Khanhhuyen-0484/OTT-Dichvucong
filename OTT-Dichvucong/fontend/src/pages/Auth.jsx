                ...
                <div className="hidden sm:flex items-center gap-2">
                  <button
                    ...
                    className={`text-sm font-semibold rounded-lg px-3 py-2 ring-1 ${
                      mode === "login"
                        ? "bg-(--gov-navy) text-white ring-(--gov-navy)"
                  ...
                  <button
                    ...
                    className={`text-sm font-semibold rounded-lg px-3 py-2 ring-1 ${
                      mode === "forgot"
                        ? "bg-(--gov-red) text-white ring-(--gov-red)"
                        : "bg-white text-slate-800 ring-slate-200 hover:bg-slate-50"
                    }`}
              ...
              {mode === "login" ? (
                <form onSubmit={handleLogin} className="mt-4 space-y-4">
                  ...
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <button
                      type="button"
                      className="text-sm font-semibold text-(--gov-red) underline underline-offset-2"
                      onClick={() => setMode("forgot")}
                    >
                      Quên mật khẩu?
                    </button>
          ...
          <div className="lg:col-span-7">
            <div className="rounded-2xl bg-white ring-1 ring-slate-200 p-6">
              ...
              <div className="mt-6 rounded-xl bg-slate-50 ring-1 ring-slate-200 p-4">
                ...
                <div className="mt-1 text-sm text-slate-700 wrap-break-word">
